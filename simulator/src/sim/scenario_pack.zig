...
pub const ScenarioPackEntry = struct {
    ...
    dashboard_policy: types.PolicyKind = .fcfs,
...
const core_pack_entries = [_]ScenarioPackEntry{
    .{ .key = "arrivals", .path = "scenarios/basic/arrivals.zon", .description = "Canonical object-style arrival ordering fixture", .dashboard_policy = .fcfs },
    .{ .key = "contention", .path = "scenarios/basic/contention.zon", .description = "Equal-arrival contention teaching fixture", .dashboard_policy = .fcfs },
    .{
        .key = "deadline-priority",
        .path = "scenarios/basic/deadline-priority.zon",
        .description = "Deadline-inspired comparison fixture",
        .dashboard_policy = .deadline,
        .canonical = true,
        .theme = .deadlines,
    ...
    .{ .key = "equal-arrival-contention", .path = "scenarios/basic/equal-arrival-contention.zon", .description = "Built-in contention alias target", .dashboard_policy = .fcfs },
    .{
        .key = "group-fairness",
        .path = "scenarios/basic/group-fairness.zon",
        .description = "Group scheduling teaching fixture",
        .dashboard_policy = .cfs_like,
        .canonical = true,
        .theme = .groups,
    ...
    .{
        ...
        .canonical = true,
        .theme = .bursty_io,
        .explanation_doc = "docs/simulator-semantics.md",
        .recommended_policy = .round_robin,
        .manual_demo = true,
        .regression_use = true,
    },
    ...
    .{ .key = "multicore-contention", .path = "scenarios/basic/multicore-contention.zon", .description = "Baseline deterministic multicore fixture", .dashboard_policy = .fcfs },
    .{ .key = "multicore-rr-quantum", .path = "scenarios/basic/multicore-rr-quantum.zon", .description = "Multicore Round Robin preemption fixture", .dashboard_policy = .round_robin },
    .{ .key = "multicore-simultaneous-complete", .path = "scenarios/basic/multicore-simultaneous-complete.zon", .description = "Deterministic same-tick completion fixture", .dashboard_policy = .fcfs },
    .{ .key = "multicore-staggered", .path = "scenarios/basic/multicore-staggered.zon", .description = "Staggered multicore arrival fixture", .dashboard_policy = .fcfs },
    .{ .key = "multicore-weighted", .path = "scenarios/basic/multicore-weighted.zon", .description = "Weighted multicore fairness fixture", .dashboard_policy = .cfs_like },
    .{
        .key = "short-vs-long",
        ...
        .canonical = true,
        .theme = .convoy,
        .explanation_doc = "docs/scenario-c-walkthrough.md",
        .recommended_policy = .fcfs,
        .manual_demo = true,
        .regression_use = true,
    },
    ...
    .{ .key = "staggered-arrivals", .path = "scenarios/basic/staggered-arrivals.zon", .description = "Built-in staggered arrivals fixture", .dashboard_policy = .fcfs },
    .{
    ...
    .{ .key = "weighted-fairness", .path = "scenarios/basic/weighted-fairness.zon", .description = "Single-core weight-aware fairness fixture", .dashboard_policy = .cfs_like },
};
