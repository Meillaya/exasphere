...
if [[ "$fixture" == "--fixture" ]]; then
  case "${3:-}" in
    ...
    runtime-alert-ordering)
      ...
      printf '%s\n%s\n' \
        '{"schema":"zig-scheduler/runtime-sample/v1","sequence":1,"state":{"status":"present","value":"enabled"},"ops":{"status":"present","value":"zigsched_minimal"},"enable_seq":{"status":"present","value":"42"},"events":{"status":"present","value":"nr_rejected: 3"},"events_hash":"reject33","nr_rejected":{"status":"present","value":"3"},"debug_dump":{"status":"missing","value":""},"policy_abi":{"policy_name":"zigsched_minimal","policy_version":"sched_ext_minimal_v1","struct_ops":"zigsched_minimal_ops","object_sha256":"unavailable","btf_required":true},"cgroup_membership_digest":"bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb","workload_alive":true,"private_command_lines_sampled":false}' \
        '{"schema":"zig-scheduler/runtime-sample/v1","sequence":2,"state":{"status":"present","value":"enabled"},"ops":{"status":"present","value":"zigsched_minimal"},"enable_seq":{"status":"present","value":"43"},"events":{"status":"present","value":"nr_rejected: 0"},"events_hash":"dead44","nr_rejected":{"status":"present","value":"0"},"debug_dump":{"status":"missing","value":""},"policy_abi":{"policy_name":"zigsched_minimal","policy_version":"sched_ext_minimal_v1","struct_ops":"zigsched_minimal_ops","object_sha256":"unavailable","btf_required":true},"cgroup_membership_digest":"cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc","workload_alive":false,"private_command_lines_sampled":false}' \
        > "$runtime_file"
