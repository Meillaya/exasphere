...
from qa.runtime_sample_core import validate_file
...
def self_test() -> None:
    from qa.protected_core_telemetry_selftest import TelemetrySelfTest, run_self_test

    run_self_test(
        TelemetrySelfTest(
            validate_input=validate_input,
            validate_vm_captured_input=validate_vm_captured_input,
            expected_errors=(ProtectedCoreTelemetryError, RuntimeSampleError),
        )
    )
