...
EXPECTED_REQUIRED_SOURCES: Final[tuple[tuple[str, str], ...]] = (
    ...
    ('fixtures/runner-substrate-proof/valid/protected-review.json', 'runner substrate proof embedded protected environment review fixture'),
    ('fixtures/protected-environment-review/invalid/api-url-repo-mismatch.json', 'protected environment review invalid API URL repository mismatch fixture'),
    ('fixtures/protected-environment-review/invalid/dirty-worktree-field.json', 'protected environment review invalid dirty worktree field fixture'),
    ('fixtures/protected-environment-review/invalid/host-mutation-true.json', 'protected environment review invalid host mutation claim fixture'),
    ('fixtures/protected-environment-review/invalid/malformed.json', 'protected environment review invalid malformed JSON fixture'),
    ('fixtures/protected-environment-review/invalid/misleading-success-output-field.json', 'protected environment review invalid misleading success output fixture'),
    ('fixtures/protected-environment-review/invalid/missing-reviewer-identity.json', 'protected environment review invalid missing reviewer identity fixture'),
    ('fixtures/protected-environment-review/invalid/missing-run-url.json', 'protected environment review invalid missing run URL fixture'),
    ('fixtures/protected-environment-review/invalid/non-approved-state.json', 'protected environment review invalid non-approved state fixture'),
    ('fixtures/protected-environment-review/invalid/privacy-unsafe-key.json', 'protected environment review invalid privacy unsafe key fixture'),
    ('fixtures/protected-environment-review/invalid/production-capacity-claim-true.json', 'protected environment review invalid production capacity claim fixture'),
    ('fixtures/protected-environment-review/invalid/release-eligible-true.json', 'protected environment review invalid release eligibility claim fixture'),
    ('fixtures/protected-environment-review/invalid/run-url-id-mismatch.json', 'protected environment review invalid run URL ID mismatch fixture'),
    ('fixtures/protected-environment-review/invalid/stale-state-field.json', 'protected environment review invalid stale state field fixture'),
    ('fixtures/protected-environment-review/invalid/wrong-comment.json', 'protected environment review invalid approval comment fixture'),
    ('fixtures/protected-environment-review/invalid/wrong-env.json', 'protected environment review invalid environment fixture'),
)
