# Simulator-first teaching surface polish

teaching is the recommended next optional distribution/teaching cut after the now-
implemented observability-comparison surfaces.
...
This workstream is intentionally about **making existing local surfaces easier
to use well**, not about introducing a new platform requirement.

## Target outcome

A contributor, reviewer, or instructor should be able to:
- pick a canonical the simulator scenario quickly
...
- make local demo commands easier to discover from README/docs and the dashboard/help path
...
- a packaging/courseware workstream beyond repo-native artifacts and docs
...
- deterministic TUI snapshot tests for dashboard/help plus the three anchors
