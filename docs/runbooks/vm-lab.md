...
For the protected-core evidence set, the current fresh PASS ledger is `evidence/lab/protected-core-pass-20260703.md` for GitHub Actions run `28629448049` at commit `f049142f4beed827a0a797c2272eaf2502c266d1`. Treat it as lab-only protected VM proof: it does not approve release, production use, performance capacity, real-host attach, or host scheduler/cgroup mutation.
