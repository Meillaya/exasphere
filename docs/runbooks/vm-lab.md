...
python3 qa/protected_core_suite_check.py --manifest evidence/lab/matrix/manual-vm-proof/manifest.json
python3 qa/protected_core_telemetry_check.py --manifest evidence/lab/matrix/manual-vm-proof/manifest.json
